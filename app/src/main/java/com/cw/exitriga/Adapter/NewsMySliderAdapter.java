...
public class NewsMySliderAdapter extends RecyclerView.Adapter<NewsMySliderAdapter.ViewHolder> {
    private LayoutInflater mInflater;
    private ViewPager2 viewPager1;
    Context context;
    List<ViewNewsData> productList;
    public NewsMySliderAdapter(Context context, ViewPager2 viewPager, List<ViewNewsData> productList) {
