...
import com.cw.exitriga.ModelClass.ViewPlaceMultipleImage;
...
public class Place_Sliding_adapter extends PagerAdapter {

    private final LayoutInflater inflater;
    Context context;
    private List<ViewPlaceMultipleImage> images;

    public Place_Sliding_adapter(Context context, @NonNull List<ViewPlaceMultipleImage> images) {
