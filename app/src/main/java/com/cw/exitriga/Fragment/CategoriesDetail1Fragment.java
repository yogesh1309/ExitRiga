...
public class CategoriesDetail1Fragment extends Fragment {
    ImageView img_back;
    Activity context;
...
//    ViewProductData viewProductData;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_categories_detail1, container, false);
        InitView(v);
        try {
            viewProductData = (List<ViewProductData>) getArguments().getSerializable("data");
        } catch (Exception e) {
            e.printStackTrace();
        }
        Click();
...
*/
    ...
    private void ViewpagerDataSet() {
        if (viewProductData.size()==0)
        {
            ...
            adapter = new MySliderAdapter(getActivity(), viewpager,viewProductData);
