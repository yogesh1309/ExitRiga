...
public class MeasuredDirectionMapFragment extends Fragment implements OnMapReadyCallback {
    Activity activity;
    ImageView img_back;
    ViewEventsData viewProductData;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_measured_direction_map, container, false);
        InitView(v);
        CurrentLocation();
        try {
            viewProductData = (ViewEventsData) getArguments().getSerializable("data");
