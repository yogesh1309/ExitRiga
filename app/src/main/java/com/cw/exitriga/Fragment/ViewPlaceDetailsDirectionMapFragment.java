...
public class ViewPlaceDetailsDirectionMapFragment extends Fragment  implements OnMapReadyCallback {
    ImageView img_back;
    Activity context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View v = inflater.inflate(R.layout.fragment_view_place_details_direction_map, container, false);
      InitView(v);
      Click();
        CurrentLocation();
      try {
          ...
          if (bundle!=null)
          {
              categoriesList = (ViewPlaceData) bundle.getSerializable("data");
