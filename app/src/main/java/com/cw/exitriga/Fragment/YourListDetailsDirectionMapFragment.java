...
public class YourListDetailsDirectionMapFragment extends Fragment implements OnMapReadyCallback {
    Activity activity;
    ImageView img_back;
    AllRoutesListData viewProductData;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_your_list_details_direction_map, container, false);
        InitView(v);
        CurrentLocation();
        try {
            viewProductData = (AllRoutesListData) getArguments().getSerializable("data");
